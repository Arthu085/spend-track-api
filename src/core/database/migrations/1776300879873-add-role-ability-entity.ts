...
export class AddRoleAbilityEntity1776300879873 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `COMMENT ON TABLE "role_abilities" IS 'Tabela de associação entre funções e permissões'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "role_abilities" ADD CONSTRAINT "FK_1e8a9df86d8adbd9e20a6a0101f" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "role_abilities" ADD CONSTRAINT "FK_285ea6ef85f557217e3c564646e" FOREIGN KEY ("ability_id") REFERENCES "abilities"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3e7e23d099fcaf78c6f4c147ac"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6dea067fc4e5e71e9ae95ed89a"`,
    );
