...
export class AddRoleEntity1775738782733 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_cdc7776894e484eaed828ca061" ON "roles" ("uuid") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_14958a120176d4e1e8be423977" ON "roles" ("status") `,
    );
    await queryRunner.query(
      `COMMENT ON TABLE "roles" IS 'Tabela de funções do sistema'`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_14958a120176d4e1e8be423977"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cdc7776894e484eaed828ca061"`,
    );
